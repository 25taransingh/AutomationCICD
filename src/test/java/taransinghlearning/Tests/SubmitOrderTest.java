...
// to remove HashMap and use less number just remove the "HashMap<String, String> input" in method argument and inside method input.get values
	...
	public void submitOrder(HashMap<String, String> input) throws IOException {
		// TODO Auto-generated method stu   TEST CICjhjghjg
...
//public Object[][] getData() {
//    // 2 rows (datasets), 2 columns (username & password)
//    Object[][] data = new Object[2][2];
//
//    // Row 0
//    data[0][0] = "user1@example.com";   // column 0 → username
//    data[0][1] = "password1";           // column 1 → password
//
//    // Row 1
//    data[1][0] = "user2@example.com";   // column 0 → username
//    data[1][1] = "password2";           // column 1 → password
//
//    return data;
//}
// ------------------------------------------------------------------------------
